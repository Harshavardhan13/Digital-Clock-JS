...
function setTime() {
    ...
    if(Number(i) == hourr){
        ...
        document.getElementById('img-container').src="./assets./wakeup_image.png";
     ...
     if(Number(j) == hourr){
        ...
        document.getElementById('img-container').src="./assets./lunch_image.png";
     ...
     if(Number(k) == hourr) {
        document.getElementById('img-container').src="./assets./goodnight_image.png";
