...
function setTime() {
    ...
    if(Number(i) == hourr){
        ...
        document.getElementById('img').style.backgroundImage="url(./assets/wakeup_image.png)";
     ...
     if(Number(j) == hourr){
        ...
        document.getElementById('img').style.backgroundImage="url(./assets/lunch_image.png)";
     ...
     if(Number(k) == hourr) {
        document.getElementById('img').style.backgroundImage="url(./assets/goodnight_image.png)";
